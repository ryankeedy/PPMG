...
class ParticleRenderer
{
    public:
        ...
        void setPositions(float *pos, int numParticles, int maxNumParticles);
        void setColors(float *pos);  //RMK
        void setVertexBuffer(unsigned int vbo, int numParticles, int maxNumParticles);

...
void ParticleRenderer::setPositions(float *pos, int numParticles, int maxNumParticles)
{
    m_pos = pos;
...
// RMK:
void ParticleRenderer::setColors(float *color)
{
    m_color = color;
}

void ParticleRenderer::setVertexBuffer(unsigned int vbo, int numParticles, int maxNumParticles)
{
    m_vbo = vbo;
    m_numParticles = numParticles;
    m_maxNumParticles = maxNumParticles;
...
void ParticleRenderer::_drawPoints()
{
    ...
    else
    {
        ...
        //glDrawArrays(GL_POINTS, 0, m_maxNumParticles);
